...
from nextdraw import utils
from nextdraw.utils import get_configured_value, assign_option_values, load_config
...
class UtilsTestCase(unittest.TestCase):
    ...
    def test_assign_option_values(self):
        ...
        print("test: test_assign_option_values")
    ...
    def test_load_config_bad_filename(self):
        print("test: test_load_config_bad_filename")
    ...
    def test_load_config_bad_syntax(self, m_run_path):
        print("test: test_load_config_bad_syntax")
        with self.assertRaises(SystemExit) as se:
